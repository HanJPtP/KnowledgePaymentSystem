...
public class MybatisPlusUtils {
    public static void main(String[] args) {
        try {
            generator("qk",//作者
                    "jdbc:mysql://192.172.0.205:3306/knowledge_qk?serverTimezone=GMT%2B8&useUnicode=true&characterEncoding=utf-8&useSSL=false",
                    "com.mysql.cj.jdbc.Driver",//数据库驱动
                    "root",//数据库帐号
                    "123456",//数据库密码
                    "com.woniu",//项目最大的包名
                    "qiukui-marketing-management-service",//项目名
                    "coupon_availableItems,coupon_details,coupon_type,validity_period");//要操作的表名,多个表名用逗号隔开
