...
import com.woniu.order.filter.JwsTokenFilter;
import com.woniu.order.handler.SimpleAccessDeniedHandler;
import com.woniu.order.handler.SimpleAuthenticationEntryPoint;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                .anyRequest()
                .permitAll(); // 开发环境permitAll
                // .authenticated();//除了上述外,都需要登录才能拥有
